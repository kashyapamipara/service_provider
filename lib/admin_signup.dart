...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future signUp({String email, String password}) async {
    try {
      ...
      setState(() {
        _isLoad = false;
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>First(adminId)));
      });
  ...
  Future<String> uploadFile(File image) async {
    ...
    Reference ref =
    FirebaseStorage.instance.ref().child("images").child("$_userName.jpg");
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            labelText: 'Enter your name/NGO name',
                          ),
                        ),
                      ),
                      Padding(
